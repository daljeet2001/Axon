...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        ...
        const argsZapController_createZap: Record<string, TsoaRoute.ParameterSchema> = {
                req: {"in":"request","name":"req","required":true,"dataType":"object"},
                body: {"in":"body","name":"body","required":true,"ref":"ZapCreateInput"},
        };
        app.post('/zap',
            authenticateMiddleware([{"jwt":[]}]),
            ...(fetchMiddlewares<RequestHandler>(ZapController)),
            ...(fetchMiddlewares<RequestHandler>(ZapController.prototype.createZap)),

            async function ZapController_createZap(request: ExRequest, response: ExResponse, next: any) {
            ...
            try {
                ...
                const controller = new ZapController();
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        const argsZapController_getZaps: Record<string, TsoaRoute.ParameterSchema> = {
                req: {"in":"request","name":"req","required":true,"dataType":"object"},
        };
        app.get('/zap',
            authenticateMiddleware([{"jwt":[]}]),
            ...(fetchMiddlewares<RequestHandler>(ZapController)),
            ...(fetchMiddlewares<RequestHandler>(ZapController.prototype.getZaps)),

            async function ZapController_getZaps(request: ExRequest, response: ExResponse, next: any) {
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        const argsZapController_getZap: Record<string, TsoaRoute.ParameterSchema> = {
                req: {"in":"request","name":"req","required":true,"dataType":"object"},
        ...
        app.get('/zap/:zapId',
            authenticateMiddleware([{"jwt":[]}]),
            ...(fetchMiddlewares<RequestHandler>(ZapController)),
            ...(fetchMiddlewares<RequestHandler>(ZapController.prototype.getZap)),

            async function ZapController_getZap(request: ExRequest, response: ExResponse, next: any) {
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        const argsTriggerController_getAvailableTriggers: Record<string, TsoaRoute.ParameterSchema> = {
        };
        app.get('/trigger/available',
            ...(fetchMiddlewares<RequestHandler>(TriggerController)),
            ...(fetchMiddlewares<RequestHandler>(TriggerController.prototype.getAvailableTriggers)),

            async function TriggerController_getAvailableTriggers(request: ExRequest, response: ExResponse, next: any) {
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        const argsActionController_getAvailableActions: Record<string, TsoaRoute.ParameterSchema> = {
        };
        app.get('/action/available',
            ...(fetchMiddlewares<RequestHandler>(ActionController)),
            ...(fetchMiddlewares<RequestHandler>(ActionController.prototype.getAvailableActions)),

            async function ActionController_getAvailableActions(request: ExRequest, response: ExResponse, next: any) {
